...
<div class="container content">
  ...
  <div class="row">
    <div class="col-sm-8 content-main">
        ...
        <?php if(is_array($userlist)): $i = 0; $__LIST__ = $userlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><a href='<?php echo ($_SESSION['urlroot']); echo ($vo['href']); ?>'>
                <?php echo ($vo['firstname']); ?>_<?php echo ($vo['lastname']); ?>
              </a></h3>
          </div>
          
          <ul class="list-group">
            <li class="list-group-item">
                <span class="badge"><?php echo ($vo['uid']); ?></span>
                ID
              </li>

            <li class="list-group-item">
                <span class="badge"><?php echo ($vo['email']); ?></span>
                EMAIL
              </li>
            <li class="list-group-item">
