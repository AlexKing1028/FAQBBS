...
<div class="container content">
  ...
  <div class="row">
    <div class="col-sm-8 content-main">
      ...
      <h3>问题</h3>
      <hr>
      <?php if(is_array($question_sum_array)): $i = 0; $__LIST__ = $question_sum_array;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="question-summary">
        <button class="btn btn-default btn-xs" disabled="disabled" type="button">
          <strong>VOTES</strong> <span class="badge"><?php echo ($vo["votes"]); ?></span>
        </button>
        <button class="btn btn-default btn-xs" disabled="disabled" type="button">
          <strong>ANSWERS</strong><span class="badge"><?php echo ($vo["answers"]); ?></span>
        </button>
        <p></p>
